...
import { db } from "."
import { categoryTable, productsTable, productVariantTable } from "./schema"
...
const products = [
	...
	{
		name: "Mochila",
		description: "Mochila resistente e confortável, ideal para o dia a dia e viagens.",
	...
	{
		name: "Shorts Active",
		description: "Shorts esportivo para atividades físicas, com tecido que absorve o suor.",
	...
	},
	{
		...
		description: "Shorts com design moderno e confortável, ideal para diversas ocasiões.",
		categoryName: "Bermuda & Shorts",
		variants: [
	...
	},
	{
		...
		description: "Bermuda premium com qualidade superior e design diferenciado.",
		categoryName: "Bermuda & Shorts",
		variants: [
	...
	// Calças
	{
		...
		description: "Calça esportiva Nike Club, confortável e versátil para treinos e uso casual.",
		categoryName: "Calças",
		variants: [
	...
	{
		name: "Calça Knit",
		description: "Calça de malha com tecido macio e confortável, ideal para relaxar.",
		categoryName: "Calças",
		variants: [
			{ color: "Preta", price: 12999 },
			{ color: "Branca", price: 12999 },
	...
	{
		name: "Calça Brooklin",
		description: "Calça com design urbano e moderno, perfeita para o street style.",
		categoryName: "Calças",
		variants: [
	...
	{
		name: "Calça Jordan",
		description: "Calça Jordan com qualidade premium e design icônico da marca.",
		categoryName: "Calças",
		variants: [
	...
	{
		name: "Camiseta ACG",
		description: "Camiseta ACG com design técnico e material de alta qualidade.",
	...
	{
		name: "Camiseta Run",
		description: "Camiseta para corrida com tecido respirável e conforto superior.",
		categoryName: "Camisetas",
		variants: [
	...
	},
	{
		...
		description: "Camiseta esportiva para atividades físicas com tecnologia Dri-FIT.",
		categoryName: "Camisetas",
		variants: [
	...
	},
	{
		...
		description: "Camiseta com estampa inspirada na natureza, confortável e estilosa.",
		categoryName: "Camisetas",
		variants: [
	...
	{
		name: "Corta Vento",
		description: "Jaqueta corta-vento leve e resistente, ideal para atividades ao ar livre.",
	...
	},
	{
		...
		description: "Jaqueta Windrunner com design clássico e proteção contra o vento.",
		categoryName: "Jaquetas & Moletons",
		variants: [
	...
	{
		name: "Jaqueta Style",
		description: "Jaqueta com estilo urbano e moderno, perfeita para compor looks casuais.",
		categoryName: "Jaquetas & Moletons",
		variants: [
	...
	// Tênis
	{
		...
		description: "Tênis Nike Vomero com tecnologia de amortecimento superior para corridas.",
		categoryName: "Tênis",
		variants: [
	...
	},
	{
		...
		description: "Tênis Nike Air Force 1, um clássico atemporal com design icônico.",
		categoryName: "Tênis",
		variants: [
	...
	try {
		...
		console.log(
			`📊 Foram criadas ${categories.length} categorias, ${
				products.length
			} produtos com ${products.reduce((acc, p) => acc + p.variants.length, 0)} variantes.`,
		)
	} catch (error) {
